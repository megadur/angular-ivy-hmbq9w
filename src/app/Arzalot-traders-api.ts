...
export class EmployeesClient implements IEmployeesClient {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return new Error("") as any as Observable<EmployeeLookupDto[]>;
                }
            } else
                return new Error(response_) as any as Observable<EmployeeLookupDto[]>;
        }));
    }
    ...
    protected processGetAll(response: HttpResponseBase): Observable<EmployeeLookupDto[]> {
        ...
        var ret= new EmployeeLookupDto[0];
        var x:any=[];
        return of([]);
    }
